  ...
  return (
    <div className="h-[55vh] lg:h-[60vh] w-full flex justify-start items-center">
      ...
      <div className="absolute w-[90%] lg:w-[40%] mx-auto">
        <h1 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold">{data?.title as string}</h1>
        <p className="text-white text-lg mt-5 line-clamp-3 ">{data?.overview as string}</p>
